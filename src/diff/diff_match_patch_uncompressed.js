...
/**
 * @file Computes the difference between two texts to create a patch.
 ...
 * @returns {{chars1: string, chars2: string, lineArray: !Array.<string>}}
 ...
 * @returns {!Array.<string|!Array.<boolean>>} Two element Array, containing the
